      ...
      {open && (
        ...
        >
          <div className="flex items-center justify-between px-4 py-3 border-b" style={{ borderColor: '#6366f120' }}>
            <h3 className="font-semibold text-sm" style={{ color: '#e2e8f0' }}>Обратная связь</h3>
            <button onClick={() => setOpen(false)} className="p-1 rounded hover:opacity-70" style={{ color: '#e2e8f070' }}>
              <X className="w-4 h-4" />
            </button>
          </div>
          ...
          {sent ? (
            <div className="p-6 text-center">
              ...
              <p className="font-semibold" style={{ color: '#e2e8f0' }}>Спасибо!</p>
              <p className="text-sm mt-1" style={{ color: '#e2e8f070' }}>Ваш отзыв помогает нам стать лучше</p>
            </div>
          ) : (
            <div className="p-4 space-y-4">
              {/* Star rating */}
              <div>
                <p className="text-sm font-medium mb-2" style={{ color: '#e2e8f0' }}>Оцените опыт</p>
                  ...
                  {[1, 2, 3, 4, 5].map(star => (
                    ...
                    >
                      <Star
                        ...
                        style={{ color: (hoverRating || rating) >= star ? '#f59e0b' : '#e2e8f050' }}
                      />
                    </button>
                  ))}
                </div>
              ...
              <div className="flex gap-2 flex-wrap">
                {['general', 'bug', 'feature', 'ux'].map(cat => (
                  <button
                    ...
                    style={{
                      background: category === cat ? '#6366f1' : '#6366f110',
                      color: category === cat ? 'white' : '#e2e8f070',
                    }}
                  >
              ...
              <textarea
                ...
                style={{ borderColor: '#6366f140', background: '#6366f110', color: '#e2e8f0' }}
              />
