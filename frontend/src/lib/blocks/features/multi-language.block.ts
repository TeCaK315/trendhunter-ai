...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    ${cp.tracksMoney ? `'dashboard.revenue': 'Revenue',
    ...
    ${cp.formType === 'sender-recipient' ? `'create.from': 'From (Your Business)',
    ...
    ${cp.hasLineItems ? `'create.lineItems': 'Line Items',
    'create.addItem': 'Add Item',
    'create.itemDescription': 'Item description',
    'create.taxAmount': 'Tax amount',
    'create.items': 'Items',` : ''}
    ${cp.hasPaymentTerms ? `'create.paymentTerms': 'Payment Terms',
    ...
    ${cp.tracksMoney ? `'clients.totalBilled': 'Total Billed',
    'clients.totalPaid': 'Total Paid',
    'clients.invoices': 'invoices',` : `'clients.totalItems': 'Total ${primaryOutputCap}s',`}
    ...
    ${cp.tracksMoney ? `'reports.totalBilled': 'Total Billed',
    ...
    'reports.billed': 'Billed',` : `'reports.totalCompleted': 'Total Completed',
    ...
    'settings.docPrefix': '${primaryOutputCap} Prefix',
    'settings.defaultNotes': 'Default Notes',
    'settings.defaultNotesHint': 'This will appear on every new ${primaryOutput} by default.',
    'settings.logoHint': 'PNG or JPG, max 500KB.',
    ${cp.tracksMoney ? `'settings.invoiceDefaults': 'Invoice Defaults',
    ...
    // Payment terms
    ${cp.hasPaymentTerms ? `'payment.dueOnReceipt': 'Due on Receipt',
  ...
  de: {
    ...
    ${cp.tracksMoney ? `'dashboard.revenue': 'Umsatz',
    ...
    'create.notesPlaceholder': 'Zus\\u00e4tzliche Notizen oder Kommentare...',
    ${cp.formType === 'sender-recipient' ? `'create.from': 'Von (Ihr Unternehmen)',
    ...
    ${cp.hasLineItems ? `'create.lineItems': 'Positionen',
    ...
    ${cp.hasPaymentTerms ? `'create.paymentTerms': 'Zahlungsbedingungen',
    ...
    ${cp.tracksMoney ? `'clients.totalBilled': 'Gesamt berechnet',
    'clients.totalPaid': 'Gesamt bezahlt',
    'clients.invoices': 'Rechnungen',` : `'clients.totalItems': 'Gesamt',`}
    ...
    ${cp.tracksMoney ? `'reports.totalBilled': 'Gesamt berechnet',
    ...
    'reports.billed': 'Berechnet',` : `'reports.totalCompleted': 'Gesamt abgeschlossen',
    ...
    'settings.docPrefix': 'Pr\\u00e4fix',
    'settings.defaultNotes': 'Standardnotizen',
    'settings.defaultNotesHint': 'Dies erscheint standardm\\u00e4\\u00dfig auf jedem neuen Eintrag.',
    'settings.logoHint': 'PNG oder JPG, max 500KB.',
    ${cp.tracksMoney ? `'settings.invoiceDefaults': 'Rechnungsstandards',
    ...
    // Payment terms
    ${cp.hasPaymentTerms ? `'payment.dueOnReceipt': 'Bei Erhalt f\\u00e4llig',
  ...
  ru: {
    ...
    'dashboard.activityThisMonth': '\\u0417\\u0430 \\u043c\\u0435\\u0441\\u044f\\u0446',
    'dashboard.inProgress': '\\u0412 \\u0440\\u0430\\u0431\\u043e\\u0442\\u0435',
    ${cp.tracksMoney ? `'dashboard.revenue': '\\u0414\\u043e\\u0445\\u043e\\u0434',
    ...
    'create.notesPlaceholder': '\\u0414\\u043e\\u043f\\u043e\\u043b\\u043d\\u0438\\u0442\\u0435\\u043b\\u044c\\u043d\\u044b\\u0435 \\u0437\\u0430\\u043c\\u0435\\u0442\\u043a\\u0438 \\u0438\\u043b\\u0438 \\u043a\\u043e\\u043c\\u043c\\u0435\\u043d\\u0442\\u0430\\u0440\\u0438\\u0438...',
    ${cp.formType === 'sender-recipient' ? `'create.from': '\\u041e\\u0442 (\\u0412\\u0430\\u0448 \\u0431\\u0438\\u0437\\u043d\\u0435\\u0441)',
    ...
    ${cp.hasLineItems ? `'create.lineItems': '\\u041f\\u043e\\u0437\\u0438\\u0446\\u0438\\u0438',
    ...
    ${cp.hasPaymentTerms ? `'create.paymentTerms': '\\u0423\\u0441\\u043b\\u043e\\u0432\\u0438\\u044f \\u043e\\u043f\\u043b\\u0430\\u0442\\u044b',
    ...
    ${cp.tracksMoney ? `'clients.totalBilled': '\\u0412\\u044b\\u0441\\u0442\\u0430\\u0432\\u043b\\u0435\\u043d\\u043e',
    'clients.totalPaid': '\\u041e\\u043f\\u043b\\u0430\\u0447\\u0435\\u043d\\u043e',
    'clients.invoices': '\\u0441\\u0447\\u0435\\u0442\\u043e\\u0432',` : `'clients.totalItems': '\\u0412\\u0441\\u0435\\u0433\\u043e',`}
    ...
    ${cp.tracksMoney ? `'reports.totalBilled': '\\u0412\\u044b\\u0441\\u0442\\u0430\\u0432\\u043b\\u0435\\u043d\\u043e',
    ...
    'reports.billed': '\\u0412\\u044b\\u0441\\u0442\\u0430\\u0432\\u043b\\u0435\\u043d\\u043e',` : `'reports.totalCompleted': '\\u0412\\u0441\\u0435\\u0433\\u043e \\u0437\\u0430\\u0432\\u0435\\u0440\\u0448\\u0435\\u043d\\u043e',
    'reports.summary': '\\u0421\\u0432\\u043e\\u0434\\u043a\\u0430',`}

    // Settings
    'settings.title': '\\u041d\\u0430\\u0441\\u0442\\u0440\\u043e\\u0439\\u043a\\u0438',
    'settings.business': '\\u0411\\u0438\\u0437\\u043d\\u0435\\u0441',
    'settings.defaults': '\\u0421\\u0442\\u0430\\u043d\\u0434\\u0430\\u0440\\u0442\\u044b',
    ...
    'settings.docPrefix': '\\u041f\\u0440\\u0435\\u0444\\u0438\\u043a\\u0441',
    'settings.defaultNotes': '\\u041f\\u0440\\u0438\\u043c\\u0435\\u0447\\u0430\\u043d\\u0438\\u044f \\u043f\\u043e \\u0443\\u043c\\u043e\\u043b\\u0447\\u0430\\u043d\\u0438\\u044e',
    'settings.defaultNotesHint': '\\u042d\\u0442\\u043e \\u0431\\u0443\\u0434\\u0435\\u0442 \\u043d\\u0430 \\u043a\\u0430\\u0436\\u0434\\u043e\\u043c \\u043d\\u043e\\u0432\\u043e\\u043c \\u044d\\u043b\\u0435\\u043c\\u0435\\u043d\\u0442\\u0435 \\u043f\\u043e \\u0443\\u043c\\u043e\\u043b\\u0447\\u0430\\u043d\\u0438\\u044e.',
    'settings.logoHint': 'PNG \\u0438\\u043b\\u0438 JPG, \\u043c\\u0430\\u043a\\u0441. 500KB.',
    ${cp.tracksMoney ? `'settings.invoiceDefaults': '\\u0421\\u0442\\u0430\\u043d\\u0434\\u0430\\u0440\\u0442\\u044b \\u0441\\u0447\\u0435\\u0442\\u043e\\u0432',
    ...
    // Payment terms
    ${cp.hasPaymentTerms ? `'payment.dueOnReceipt': '\\u041f\\u0440\\u0438 \\u043f\\u043e\\u043b\\u0443\\u0447\\u0435\\u043d\\u0438\\u0438',
